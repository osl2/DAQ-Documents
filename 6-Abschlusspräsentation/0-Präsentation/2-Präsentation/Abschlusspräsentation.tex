...
\frametitle{GitHub - FreeJDaq - Commits}
    ...
    symbolic x coords={1.7,8.7,15.7,22.7,29.7,5.8,12.8,19.8,26.8},xticklabels={1.7,8.7,15.7,22.7,29.7,5.8,12.8,19.8,26.8},
    ]
    
    \addplot coordinates
    {(1.7,6) (8.7,114) (15.7,123) (22.7,111) (29.7,205) (5.8,49) (12.8,72) (19.8,112) (26.8,29)};
    \end{axis}
    \end{tikzpicture}
    Insgesamt 824 Commits, 51/64 Issues closed
\end{frame}
...
\frametitle{GitHub - DAQDocuments}
  \centering
    ...
    symbolic x coords={Pflichtenheft, Entwurf, Implementierung, Qualitätssicherung},xticklabels={Pflichtenheft, Entwurf, Implementierung, Qualitätssicherung},
    ]
    
    \addplot coordinates
    {(Pflichtenheft,7600) (Entwurf,8000) (Implementierung,4900) (Qualitätssicherung,5900)};
    \end{axis}
    \end{tikzpicture}
    Insgesamt ca. 26400 Wörter über 975 Commits
\end{frame}
...
\item Vor der Implementierung die nötigen Tools aussuchen und in diese einlesen
\end{itemize}
\end{frame}
