...
\item[F260] Bausteine können durch \gls{dragdrop} in die Menüleiste wieder aus dem Konfigurationsfeld entfernt werden.
...
\item[F440] Die Anwendung sollte dem Benutzer automatisch bei Betätigen des Messung löschen-Button oder bei Schließen der Anwendung darauf hinweisen, dass die Messdaten ohne Speichern der Messdaten verloren gehen.
...
\item[F470] Bei enthaltenen Konfigurationsbausteine erhalten Informationen, über welche der Benutzer Informationen und Hilfestellung bereitgestellt bekommt.
...
\item []\textbf{Wichtige abgedeckte Funktionale Anforderungen, die noch nicht abgedeckt wurden:} F230 füge Darstellung, F470 Hilfe Bausteine
