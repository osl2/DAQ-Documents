...
\begin{itemize}
	...
	\item 
	\begin{MussKrit} 			
		Der Benutzer soll einen Baustein zur Messkonfiguration hinzufügen können, d.h. er soll einen Prototypen auswählen und das Bausteinexemplars auf der Konfigurationsfeld platzieren können. 
	\end{MussKrit}
	
	\item 
	\begin{MussKrit} 		
		Der Benutzer soll die Baustein-Eigenschaften und die Position des Bausteins auf der Konfigurationsfeld nach seinen Wünschen anpassen können.
	\end{MussKrit}
	
	\item 
	\begin{MussKrit} 			
		Der Benutzer soll einen Baustein aus der Messkonfiguration entfernen können.
	\end{MussKrit}
