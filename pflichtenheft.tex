...
Ein Risiko, das sich durch alle Projektphasen durchzieht, ist der Ausfall eines Teammitglieds, beispielsweise durch Krankheit. Bei einem Team von fünf Mitgliedern, bedeutet ein Ausfall ein Verlust von 20\%. Unsere Gegenmaßnahme in einem solchen Fall wäre dann nicht nur die Einplanung von Pufferzeit in jede Projektphase, sondern auch der Verzicht auf die Umsetzung von Sollkriterien. Ein weiteres phasenübergreifendes Risiko ist ein Ausfall wegen Urlaub oder Klausuren. Dieses Risiko wird aber durch unsere frühzeitige Planung und durch das Einplanen von Klausurpausen minimiert.
