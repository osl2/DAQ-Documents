...
Je spezieller eine Anwendung ist desto schwieriger fällt es Laien einen einstieg in deren Verwendung zu erhalten. Noch schwieriger wirde es, wenn die Anwendung in einem komplexen Gebiet, wie etwa der Physik zum einsatz kommt.

Die Anwendung soll daher als Rampe zwischen der Schulbildung und der weiterführenden wissenschaft dienen. Das Verwenden von Messtechniken ist wichtig. Es ist auch nützlich für andere Bereiche der wissenschaft.Phypidaq liefert die physikalischen Daten. Ist schwer zu verwenden. Wie die meisten wissenschaftlichen programme.
