...
\begin{itemize}
\item[\textbf{F010}] Die Benutzer erreichen nach Öffnung der Anwendung direkt die \gls{GUI}, welche aus Menüleiste, Kofigurationsfeld und Darstellungsfeld besteht.
\item[\textbf{F020}] Die Anwendung ist über Optionen konfigurierbar. 
...
\item[\textbf{450}] Die Anwendung sollte dem Benutzer eine aussagekräftige Fehlermeldung zurückgeben, falls es zu einem Datenabbruch der Messdaten kommt.
