...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T010}
		\label{T010-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T020}
		\label{T020-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T030}
		\label{T030-Ablauf}
	\end{center}
\end{figure}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T040}
		\label{T040-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T050}
		\label{T050-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T200}
		\label{T200-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T210}
		\label{T210-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{kurze Darstellung des Ablaufs von Testfall T220}
		\label{T220-Ablauf}
	\end{center}
\end{figure}
\begin{itemize}
