...
\newglossaryentry{Stand-Alone-Kommunikation}{
	...
	description={Bezeichnet im Kontext unseres Software-Projekt die systeminterne Kommunikation innerhalb eines Betriebssystems, beispielsweise per Interprozess-Kommunikation (IPC.)}
	}


\newglossaryentry{Local-Loop}{
	name={Local-Loop},
	description={Bezeichnet einen virtuellen Netzwerkadapter, der Pakete, die an ihn verschickt werden, unmittelbar danach auch wieder empfängt.}
}

\subject{Pflichtenheft}
\title{Visuelle ProgrammiersBezeichnet im Kontext unseres Software-Projekt die systeminterne Kommunikation innerhalb eines Betriebssystems, beispielsweise per Interprozess-Kommunikation (IPC.)prache für den Physikunterricht zur Datenerfassung auf einem Raspberry Pi}
