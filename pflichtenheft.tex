...
\begin{itemize}
\item[\textbf{F010}] Die Benutzer erreichen nach Öffnung der Anwendung direkt die \gls{GUI}, welche aus Menüleiste, Konfigurationsfeld und Darstellungsfeld besteht.
...
\item[\textbf{(opt.) F090}] Der Benutzer soll in F050 weitere Sensoren hinzufügen können.
\item[\textbf{(opt.) F100}] Der Benutzer soll in F060 weitere Transformation hinzufügen können.
\item[\textbf{(opt.) F110}] Die Transformationen in F100 sollen in eigenen Python-Skripten geschrieben werden können.
\end{itemize}
...
\item[\textbf{(opt.) F270}] Die Anwendung besitzt eine Check-Funktion, welche die \gls{Benutzerkonfiguration} auf Vollständigkeit und Korrektheit kontrolliert
\item[\textbf{(opt.) F280}] Durch F270 wird durch visuelle Rückmeldung dargestellt,ob die Konfiguration verwendet werden kann.
...
\item[\textbf{(opt.) F500}] Die Anwendung stellt dem Benutzer weitere Sprachpakete für die \gls{GUI} zur Verfügung.
\item[\textbf{(opt.) F510}] Durch F020 ist die Sprache für den Benutzer änderbar.
...
\item[\textbf{(opt.) F530}] Durch F020 sollte der Benutzer die in der Anwendung verwendeten Farben ändern können.
\item[\textbf{(opt.) F540}] Durch F020 sollte der Benutzer die in der Anwendung verwenden Buchstabengröße verändern können.
