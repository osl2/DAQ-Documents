...
\item[F20] Der Benutzer öffnet durch den Optionen-Knopf die Einstellungen.
\item[F30] Der Benutzer kann durch den Datei-Knopf die Dateiverwaltung öffnen.
\item[F40] Der Benutzer kann durch den Hilfe-Knopf das Hilfe Fenster öffnen.
\end{itemize}

\subsubsection{Menüfeld}

\begin{itemize}
\item[F50] Der Benutzer öffnet durch den Sensoren-Knopf die Auswahl an Sensoren.
\item[F60] Der Benutzer öffnet durch den Verbindungen-Knopf die Auswahl an Verbindungen.
\item[F70] Der Benutzer öffnet durch den Darstellungen-Knopf die Auswahl an Darstellungen.
...
\item[F90] Der Benutzer kann durch den Sensoren hinzufügen-Knopf weitere Sensoren hinzufügen.
...
\item[F510] Durch F20 ist die Sprache für den Nutzer änderbar.
...
\item[F530] Durch F20 sollte der Benutzer die in der Anwendung verwendeten Farben ändern können.
\item[F540] Durch F20 sollte der Benutzer die in der Anwendung verwenden Buchstabengröße verändern können.
