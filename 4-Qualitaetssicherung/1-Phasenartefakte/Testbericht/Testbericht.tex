...
\begin{tabular}{| p{0,5cm} | p{6,5cm} | p{3,5cm} | p{3,5cm} |}
	...
	&
	Beim Drücken des Knopfes öffnet sich das "Eigenschaften" Fenster mit Baustein-Spezifischen Informationen über den 				Baustein. Eigenschaften lassen sich bearbeiten und der dadurch neu entstandene Baustein soll gespeicht oder weiterverwendet werden können.
	& 
